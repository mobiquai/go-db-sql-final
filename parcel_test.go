...
func TestAddGetDelete(t *testing.T) {
	...
	require.NoError(t, err)          // завершить тест, если функция вернула ошибку
	require.Greater(t, id, int64(0)) // завершить тест, если пустое (id дожен быть больше 0, если предыдущий тест пройден)
	...
	testGet, err = store.Get(id)
	require.Error(t, err)    // завершить тест, если функция НЕ вернула ошибку
